<template>
  <section class="hero-section">
    ...
    <div class="carousel">
      <div class="carousel-slides">
        ...
        <div class="carousel-slide" :class="{ active: currentSlide === 2 }">
          <img src="@/assets/PIF違規.jpg.jpg" alt="Slide 3" class="carousel-image" />
        </div>
      </div>
    </div>
    ...
    <div class="info-sections1">
      <div class="info-card">
        <img src="@/assets/廣告審核放大鏡圖.jpg" alt="test" class="card-icon" />
        <h3>降低政府查核廣告風險</h3>
        <h3>減少非必要的支出風險</h3>
        <ul>
          <li>◆ 有效控管風險及錯誤</li>
      ...
      <div class="info-card">
        <img src="@/assets/一鍵快速審查.png" alt="Cosmetics" class="card-icon" />
        <h3>一鍵快速AI審查</h3>
        <h3>掌握你的每分每秒</h3>
        <ul>
          <li>◆ 匯入文案免費快速審查</li>
      ...
      <div class="info-card">
        <img src="@/assets/簽署圖.jpg" alt="Cosmetics" class="card-icon" />
        <h3>提供化妝品安全資料簽署</h3>
        <ul>
          <li>◆ 具化妝品安全資料簽署人員證照</li>
          <li>◆ 專業簽署人員直接簽署</li>
          <li>◆ 有效管理及建立PIF檔案</li>
        </ul>
      </div>
